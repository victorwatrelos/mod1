...
double				Noise::sound3D(double x, double y, double z, int octaves, double persistence)
{
	double			total = 0;
	...
	{
		total += ((Noise::noise3D(x / frequency, y / frequency, z / frequency) + 1) / 2) * amplitude;
...
double				Noise::slerp(double t, double a, double b)
{
	t = (1 - cos(t * M_PI)) * 0.5;
	return a + t * (b - a);
}
...
int Noise::p[] = {151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,
	...
	67,29,24,72,243,141,128,195,78,66,215,61,156,180,151,160,137,91,90,15,131,
